from utils.strategies import ShiftPrediction
...
def main():
    ...
    cerebro.addstrategy(ShiftPrediction, print_log=True)
...
if __name__ == '__main__':
    # 17_shifted_backtest.py -d ./data/forex_2021/hour_bar/bid/EURUSD_from_20210101_to_20211231_H1_BID.csv
