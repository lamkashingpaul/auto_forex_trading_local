...
def main():
    args = backtest_basic.get_default_parser('Sample RSI Backtest').parse_args()
...
if __name__ == '__main__':
    # 05_sample_rsi_backtest.py -d ./data/forex_2021/hour_bar/bid/EURUSD_from_20210101_to_20211231_H1_BID.csv
    main()
